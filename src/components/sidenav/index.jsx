...
export default function SideNav({ content, settings }) {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <CssBaseline />
      <AppBar style={{ background: "#2660bd" }} position="fixed" open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <Typography variant="h6" noWrap>
            {settings.pageName ?? "props.settings.pageName was empty"}
          </Typography>
        </Toolbar>
      </AppBar>
